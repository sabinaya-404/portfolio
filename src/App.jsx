...
function App() {
  ...
  <div className="project-tags">
    ...
    {/*<span className="project-status">BUILDING</span> Commented it out Just in case*/}
    
  <div className="project-bottom">
   {/* <span>FULL-STACK WEB APP</span><br></br> */}
    <a href="https://github.com/sabinaya-404/portfolio-management-system" className="project-status" target = "_blank" rel = "noopener noreferrer">VIEW ON GITHUB</a>
  </div>
</div>
      </section>
